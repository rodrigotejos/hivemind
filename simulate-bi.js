...
async function runSimulation() {
  console.log('🚀 Iniciando Simulação do AI-DLC para dashboard-bi...\n');
  ...
  const project = await apiFetch(`${API_URL}/projects`, {
    ...
    body: JSON.stringify({ name: 'dashboard-bi', description: 'Sistema de Business Intelligence e visualização de métricas de performance.' })
  });
